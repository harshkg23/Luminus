...
function SignInForm() {
  ...
  return (
    <div className="min-h-screen bg-[#050508] flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="absolute bottom-1/4 right-1/4 w-64 h-64 rounded-full bg-secondary/5 blur-[100px] pointer-events-none" />
      ...
      <div className="relative w-full max-w-sm z-10">
        ...
        <div className="glass-panel rounded-2xl p-8 shadow-[0_0_60px_rgba(0,245,255,0.05)]">
          <h1 className="font-headline text-xl font-bold text-on-surface mb-1">Sign in</h1>
        ...
        <p className="text-center font-mono text-[10px] text-[#b9caca]/30 mt-6">
          No account?{" "}
          <Link href="/auth/signup" className="text-[#00dce5] hover:underline">
            Create one
          </Link>
        </p>
      </div>
